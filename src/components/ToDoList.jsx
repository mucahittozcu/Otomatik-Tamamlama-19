...
export default function ToDoList() {
  ...
  function handleEnter(event) {
    if (newItemInput.trim()) {
      if (event.key === 'Enter') {
        ...
        scrollToBottom()
        // // Bu fonksiyon, bir belgenin veya bir elemanın en altına kaydırılmasını sağlar. 
      }
    }
  }
  ...
  // // Ekranı listeye son eklenen öğeye kaydırır 
...
//  }
  ...
  /* Challenge
    ...
    1. ClassName'i "new-item-input" olan text input focus'ta olduğunda, opacity 
     ...
     // // value değeri eksikti artık input temizleniyor
